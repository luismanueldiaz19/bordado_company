...
class AddIncidenciaMainDesdeWork extends StatefulWidget {
  const AddIncidenciaMainDesdeWork(
      {super.key, required this.pickedDepart, required this.orden});
  final Department? pickedDepart;
  final Sublima orden;

  @override
  State<AddIncidenciaMainDesdeWork> createState() =>
      _AddIncidenciaMainDesdeWorkState();
}

class _AddIncidenciaMainDesdeWorkState
    extends State<AddIncidenciaMainDesdeWork> {
...
//     what_happed, compromiso, estado, registed_by
  ...
  Future addIncidenciaCompleta(context) async {
    ...
    var data = {
      ...
      'department_find': widget.pickedDepart?.nameDepartment,
  ...
  void initState() {
    ...
    controllerLogo.text = widget.orden.nameLogo!;
    controllerNumOrden.text = widget.orden.numOrden!;
    controllerFicha.text = widget.orden.ficha!;
  }
                  ...
                  SlideInLeft(
                    ...
                    child: Container(
                      ...
                      child: TextButton.icon(
                        ...
                        label: Text(
                            widget.pickedDepart != null
                                ? widget.pickedDepart!.nameDepartment.toString()
                                : 'Donde se encontró?',
    ...
    await showDialog(
        ...
        builder: (context) {
          return SelectedDepartments(
            pressDepartment: (val) {
              setState(() {
                //  widget.pickedDepart = Department(
